...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final androidx.recyclerview.widget.LinearLayoutManager listLayoutManager =
        ...
        adapter = new ProductAdapter(productList, (product, position) -> {
            ...
            int nameResId = this.getResources().getIdentifier(
                    product.getName(),
                    "string",
        ...
        // Bottom padding to avoid overlap with bottom navigation
    ...
    private void updateWelcomeMessage() {
        ...
        if (displayName != null && !displayName.trim().isEmpty()) {
            homeWelcome.setText(
                    getString(R.string.home_welcome_user, displayName)
            );
        } else {
